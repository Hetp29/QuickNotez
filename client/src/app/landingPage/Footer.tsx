...
const Footer: React.FC = () => {
  return (
    <footer className="w-full py-6 bg-gray-100 dark:bg-black text-gray-800 dark:text-gray-300 border-t border-gray-300 dark:border-gray-800 transition-colors duration-300">
